        ...
        <>
            {fromtext === 'allcontracts' ? (
                <Button
                    ...
                    onClick={handleOpen}
                    startIcon={
                        <img src={ImportDetailsIcon} style={{ height: '18px', width: '18px' }} />
                    }
                    sx={{
                        textTransform: 'none',
                        fontSize: '16px',
                ...
                <Button
                    ...
                    onClick={handleOpen}
                    startIcon={
                        <img src={ImportBlueIcon} style={{ width: '18px', height: '18px' }} />
                    } // Example icon
            ...
            <Popover
                open={popopenUpl}
                anchorEl={anchorElUpl}
                disableScrollLock
                onClose={handleCloseUpl}
                anchorOrigin={{ vertical: 'bottom', horizontal: 'left' }}
                sx={{
                    boxShadow: 'none',
                    marginLeft: fromtext === 'allcontracts' ? '-670px' : '140px',
                    marginTop: '-100px',
                }}
                slotProps={{
                    paper: {
            ...
            >
                <div className="uploadbox">
                    ...
                    <div className="smallbox">
                        <IconButton>
                            <img src={ImpFileIc} style={{ width: '85', height: '85' }} />
                        </IconButton>
                        <p className="dragtext">
                            Drag and drop your files here or{' '}
                            <a style={{ color: '#1093FF', cursor: 'p' }}>Browse Files</a>
                        </p>
                    </div>
                </div>
            </Popover>
