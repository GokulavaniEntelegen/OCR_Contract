...
const ChatBotPop: React.FC = () => {
    ...
    return (
        ...
        <Popover open = {popopen} anchorEl={anchorEl} onClose={handleClose} disableScrollLock anchorOrigin={{vertical: "top", horizontal:"right"}} sx={{boxShadow: "none", marginLeft: "10px", marginTop: "-20px"}}slotProps={{
            paper: {
            elevation: 0,
            sx: {
                boxShadow: "none"
