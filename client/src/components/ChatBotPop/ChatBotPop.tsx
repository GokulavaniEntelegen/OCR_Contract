    ...
    return (
        <>
            ...
            <Popover
                ...
                sx={{ boxShadow: 'none', marginLeft: '-65px', marginTop: '-80px' }}
                slotProps={{
                    paper: {
                        elevation: 0,
                        sx: {
            ...
            >
                <Box className="chatbox">
                    <div
                        className="chattop"
                        style={{
                            background: `linear-gradient(140deg, #2B80EC,#13C6FF,#16DBCC,#F3B960,#2B80EC
                            )`,
                        ...
                        <div style={{ display: 'flex', gap: '30px' }}>
                            <div style={{ flex: 3 }}>
                                ...
                                <p className="livetext">
                                    A live chat interface that allows for seamless connection.
                                </p>
                            </div>
                            <div
                                style={{
                    ...
                    <div className="chatbottom">
                        ...
                        <div className="galleryleft">
                            <IconButton>
                                <img
                                    src={GalleryCustomIcon}
                                    style={{ width: '24px', height: '24px' }}
                                />
                            </IconButton>
                            <IconButton>
                                <img
                                    src={ArrowBlueRightIcon}
                                    style={{ width: '40px', height: '40px' }}
                                />
                            </IconButton>
                        </div>
