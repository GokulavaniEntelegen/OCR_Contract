...
function ContractScan() {
    ...
    useEffect(() => {
        ...
        setFormLoading(false);
        console.log('Data: ' + tempFormData.map(field => field.value));
    }, []);

    const changedIndexes1 = fieldData
        .map((value: string, index: number) => (value !== initFiledVals[index] ? index : null))
        .filter((index): index is number => index !== null);

    const changedIndexes = formData
        .map((field: newIfield, index: number) =>
            field.value !== initFiledVals[index] ? index : null
        )
        .filter((index): index is number => index !== null);
    ...
    const saveTableRows = async () => {
        ...
        // } catch (error) {
        //     console.log(
        //         'Error Occured during saving a row to tablerows present at db.json: ' + error
        //     );
        // }
        // const newRow= {fields: formData};
        setJsonData(prev => ({
            ...
            <div style={{ padding: '30px 80px 0px 80px' }}>
                ...
                <div className="fileandforms">
                    ...
                    {!AILoading ? (
                        <div className="forms">
                            <div className="formtop">
                                ...
                                <div className="edittopactions">
                                    ...
                                    <IconButton>
                                        <img
                                            src={DuplicateBlueIcon}
                                            style={{ width: '20px', height: '20px' }}
                                        />
                                    </IconButton>
                                    <IconButton>
                                        <img
                                            src={ExportDataBlueIcon}
                                            style={{ width: '20px', height: '20px' }}
                                        />
                                    </IconButton>
                            ...
                            <div key = {index}>
                                ...
                                {changedIndexes.length !== 0 && (
                                    <div className="viewedit">
                                        ...
                                        >
                                            <p className="outof">
                                                {changedIndexes.length} out of {formData.length}{' '}
                        ...
                        <div
                            style={{ flex: 1, padding: '35px', borderLeft: '1px solid #9A9A9A80' }}
                        >
